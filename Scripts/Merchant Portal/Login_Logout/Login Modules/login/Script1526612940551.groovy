...
WebUI.setText(findTestObject('Login_OR/a.username_input'), username)

WebUI.setText(findTestObject('Login_OR/b.password_input'), password)

WebUI.click(findTestObject('Login_OR/c.button_LOGIN'))
